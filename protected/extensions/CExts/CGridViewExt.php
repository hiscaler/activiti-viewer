...
class CGridViewExt extends CGridView {
    ...
    public $pager = array('class' => 'CLinkPagerExt');
//    public $afterAjaxUpdate = "function() { fnProcessingImagePreview(); }";
...
//                $this->checkBoxHtmlOptions['name'] = $name;
            ...
            $content = '<span style="padding: 7px 5px; margin-left: 1px;"><input id="' . $this->id .'_check_all" type="checkbox" /></span><a class="delete-all-selected-items clear" id="batch-delete-all-selected-items" href="javascript: void(0)">批量删除</a>';
